        ...
        <div class="row" style="margin:0px;height:100%" >
            ...
            <div class="right" style="background-color:#ddd;">
                ...
                try {
                    ...
                    $query = $dbhandler->query('select * from admin_upload where subject="csa"');
                    while ($r = $query->fetch()) {
                    ...
                    if (!empty($_POST['link']) || !empty($_POST['about'])) {
                        $query = $dbhandler->query('insert into youtube values(NULL,' . '"' . $_POST['link'] . '",' . '"csa",' . '"' . $_POST['about'] . '");');
                    }


                    $query = $dbhandler->query('select * from youtube where branch="csa"');
                    ...
                    if (isset($_COOKIE['ausername'])) {
                        ...
                        echo '<form action="scsa.php" method="post" enctype="multipart/form-data">

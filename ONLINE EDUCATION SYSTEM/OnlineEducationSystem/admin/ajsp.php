        ...
        <div class="row" style="margin:0px;height:10000px" >
            ...
            <div class="right" style="background-color:#ddd;">
                ...
                try {
                    ...
                    $query = $dbhandler->query('select * from admin_upload where subject="jsp"');
                    while ($r = $query->fetch()) {
                    ...
                    if (!empty($_POST['link']) || !empty($_POST['about'])) {
                        $query = $dbhandler->query('insert into youtube values(NULL,' . '"' . $_POST['link'] . '",' . '"jsp",' . '"' . $_POST['about'] . '");');
                    }


                    $query = $dbhandler->query('select * from youtube where branch="jsp"');
                    ...
                    if (isset($_COOKIE['ausername'])) {
                        ...
                        echo '<form action="sjsp.php" method="post" enctype="multipart/form-data">

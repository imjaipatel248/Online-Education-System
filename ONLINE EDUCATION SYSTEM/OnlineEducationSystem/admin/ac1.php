            ...
            <div class="right" style="background-color:#ddd;">
                ...
                try {
                    ...
                    if (!empty($_POST['link1']) || !empty($_POST['about1'])) {
                        $query = $dbhandler->query('insert into link values(NULL,' . '"' . $_POST['link1'] . '",' . '"c",' . '"' . $_POST['about1'] . '");');
                    }
                    ...
                    if (!empty($_POST['link']) || !empty($_POST['about'])) {
                        $query = $dbhandler->query('insert into youtube values(NULL,' . '"' . $_POST['link'] . '",' . '"c",' . '"' . $_POST['about'] . '");');
                    }


                    $query = $dbhandler->query('select * from youtube where branch="c"');
                    ...
                    $query = $dbhandler->query('select * from link where branch="c"');
                    echo '<table class="right" style="background-color:#ddd;">';
                    $i=1;
                    while ($r = $query->fetch()) {
                        $fnm=$r['link'];

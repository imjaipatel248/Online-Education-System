        ...
        <div class="row" style="margin:0px;height:100%" >
            ...
            <div class="right" style="background-color:#ddd;">
                ...
                try {
                    ...
                    $query = $dbhandler->query('select * from admin_upload where subject="dm"');
                    while ($r = $query->fetch()) {
                    ...
                    if (!empty($_POST['link']) || !empty($_POST['about'])) {
                        $query = $dbhandler->query('insert into youtube values(NULL,' . '"' . $_POST['link'] . '",' . '"dm",' . '"' . $_POST['about'] . '");');
                    }


                    $query = $dbhandler->query('select * from youtube where branch="dm"');
                    ...
                    if (isset($_COOKIE['ausername'])) {
                        ...
                        echo '<form action="sdm.php" method="post" enctype="multipart/form-data">

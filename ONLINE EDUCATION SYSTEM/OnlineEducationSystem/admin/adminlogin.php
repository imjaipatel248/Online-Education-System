...
<body>
        ...
        if (!empty($_POST['ausername']) || !empty($_POST['apassword'])) {
            ...
            try {
                ...
                $query = $dbhandler->query('select adminusername from phpadmin where adminusername=' . '"' . $username . '"' . 'and adminpassword=' . '"' . $password . '"');
                ...
                if ($x == 1) {
                    ...
                    setcookie('ausername', $username, time() + (86400 * 30), "/");
			...
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="apassword" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">

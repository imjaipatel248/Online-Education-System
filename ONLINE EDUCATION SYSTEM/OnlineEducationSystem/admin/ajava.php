            ...
            <div class="right" style="background-color:#ddd;">
                ...
                try {
                    ...
                    if (!empty($_POST['link1']) || !empty($_POST['about1'])) {
                        $query = $dbhandler->query('insert into link values(NULL,' . '"' . $_POST['link1'] . '",' . '"java",' . '"' . $_POST['about1'] . '");');
                    }
                    ...
                    if (!empty($_POST['link']) || !empty($_POST['about'])) {
                        $query = $dbhandler->query('insert into youtube values(NULL,' . '"' . $_POST['link'] . '",' . '"java",' . '"' . $_POST['about'] . '");');
                    }


                    $query = $dbhandler->query('select * from youtube where branch="java"');
                    ...
                    $query = $dbhandler->query('select * from link where branch="java"');
                    echo '<table class="right" style="background-color:#ddd;">';
                    $i=1;
                    while ($r = $query->fetch()) {
                        $fnm=$r['link'];
